...
Input:  vintage_score (from Model 1), 1855 classification tier (1–5)
Output: predicted château score (0–100)

Results:
  Train R²: 0.657  |  CV R²: 0.653  |  MAE: 1.28 pts  |  Gap: 0.4%
  3rd Growth = reference category
  5th Growth NOT significant (p=0.44) — scores same as 3rd Growth
  Biodynamic NOT included — belongs in Model 3 (price)

Key residuals (overperformers vs classification prediction):
